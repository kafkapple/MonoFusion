...
def main():
    ...
    parser.add_argument("--rgb_loss_mode", type=str, default="standard",
                        choices=["standard", "balanced", "two_pass", "fg_only"],
                        help="RGB loss: 'standard'=full L1, 'balanced'=FG/BG region balanced, 'two_pass'=structural FG/BG separation, 'fg_only'=FG region only (for num_bg=0 isolation experiments)")
